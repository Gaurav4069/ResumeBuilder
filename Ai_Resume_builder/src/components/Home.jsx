...
>
    <div
        className="absolute inset-0 sm:bg-transparent sm:from-gray-900/95 sm:to-gray-900/25 ltr:sm:bg-gradient-to-r rtl:sm:bg-gradient-to-l"
    ></div>

    <div
        className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8"
    >
        <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right pl-24">
            <h1 className="text-3xl font-extrabold text-white sm:text-5xl">
                Let us find your
                <strong className="block font-extrabold text-purple-600"> Forever Home. </strong>
            </h1>
        ...
        {/* Right Side Icon */}
        <div className="hidden lg:block lg:absolute bg-white rounded-xl lg:right-10 lg:top-1/2 lg:transform lg:-translate-y-1/2">
