...
const Home = () => {
    return (
        <div className='bg-[#000000]'>
            ...
            <section
                className="relative bg-[url(https://wallpaperaccess.com/full/3030704.jpg)] bg-cover opacity-80 bg-center bg-no-repeat"
            >
                <div
            ...
            {/* features */}
            <section id="features" className=" rounded-lg  space-y-6 bg-[#00000]  md:py-12 lg:py-20">

                <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">

                    <h2 className="font-bold text-3xl text-[#FAE6D1] leading-[1.1] sm:text-3xl md:text-6xl">Features</h2>
